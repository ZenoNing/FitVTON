...
class BoxMesh(wrappers.VisPattern):
    ...
    def save_box_mesh_obj(self, with_normals=False, in_uv_config={}, mat_name='panels_texture'):
        ...
        panel_names = self.panelNames if hasattr(self, 'panelNames') else None
        uvs = texture_mesh_islands(
            ...
            texture_bindings_path=uv_config['texture_bindings_path'],
        )
        save_obj(
    ...
    def serialize(self, paths: PathCofig, tag='', 
        ...
        if hasattr(self.paths, 'in_body_mesh'):
            if self.paths.in_body_mesh.exists():
                shutil.copy(self.paths.in_body_mesh, self.paths.body_mesh)
            else:
