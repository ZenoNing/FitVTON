...
class FluxKontextPipeline(
    ...
    def __call__(
        ...
        # If the area does not surpass max_area, use the original height and width
        ...
        if (ip_adapter_image is None and ip_adapter_image_embeds is None) and (
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if image_embeds is not None:
                    self._joint_attention_kwargs["dino_adapter_image_embeds"] = image_embeds
