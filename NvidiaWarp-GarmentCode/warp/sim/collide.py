...
def find_intersecting_particles(
        ...
        cloth_collision_group_ids: wp.array(dtype=int),
        disable_inter_garment_collision: int,
        # outputs
    ...
    if wp.mesh_query_edge(particle_shape, idx_k, idx_l, t, face_u, face_v, sign, normal, face_index):
        ...
        inter_garment = (
            disable_inter_garment_collision != 0
            and cloth_collision_group_ids[idx_k] != 0
            and cloth_collision_group_ids[f1] != 0
            and cloth_collision_group_ids[idx_k] != cloth_collision_group_ids[f1]
        )
        if not inter_garment:
...
def create_self_edge_contacts(
    ...
    particle_shape: wp.uint64,  
    intersecting_particles: wp.array(dtype=int),
    cloth_collision_disabled_particles: wp.array(dtype=int),
    cloth_collision_group_ids: wp.array(dtype=int),
    disable_inter_garment_collision: int,
    edge_indices: wp.array(dtype=int),
    ...
    if cloth_collision_disabled_particles[p_a_idx] != 0 or cloth_collision_disabled_particles[p_b_idx] != 0:
        return
    ...
    while wp.mesh_query_aabb_next(query, face_index):
        ...
        disabled_face = (
            cloth_collision_disabled_particles[p0_idx] != 0
            or cloth_collision_disabled_particles[p1_idx] != 0
            or cloth_collision_disabled_particles[p2_idx] != 0
            or (
                disable_inter_garment_collision != 0
                and cloth_collision_group_ids[p_a_idx] != 0
                and cloth_collision_group_ids[p0_idx] != 0
                and cloth_collision_group_ids[p_a_idx] != cloth_collision_group_ids[p0_idx]
            )
        )
        if disabled_face:
...
def create_self_point_triangle_contacts(
    ...
    if cloth_collision_disabled_particles[particle_index] != 0:
        return
    ...
    while wp.mesh_query_aabb_next(query, face_index):
        ...
        if (p0_idx == tid or p1_idx == tid or p2_idx == tid
                or cloth_collision_disabled_particles[p0_idx] != 0
                or cloth_collision_disabled_particles[p1_idx] != 0
                or cloth_collision_disabled_particles[p2_idx] != 0
                or (
                    disable_inter_garment_collision != 0
                    and cloth_collision_group_ids[particle_index] != 0
                    and cloth_collision_group_ids[p0_idx] != 0
                    and cloth_collision_group_ids[particle_index] != cloth_collision_group_ids[p0_idx]
                )):
    ...
    if model.particle_count and model.global_collision_filter:
        ...
        wp.launch(
            ...
            inputs = [
                ...
                model.cloth_collision_group_ids,
                model.disable_inter_garment_collision
            ],
            outputs=[
    ...
    if model.particle_count and model.spring_count:
        ...
        wp.launch(
            ...
            inputs=[
                ...
                model.cloth_collision_disabled_particles,
                model.cloth_collision_group_ids,
                model.disable_inter_garment_collision,
                model.spring_indices,
