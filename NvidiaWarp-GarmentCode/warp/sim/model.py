    ...
    def __init__(self, vertices: List[Vec3], indices: List[int], compute_inertia=True, is_solid=True):
        ...
        if compute_inertia:
            self.mass, self.com, self.I, _ = compute_mesh_inertia(
                1.0, self.vertices, self.indices, is_solid=is_solid
            )
        else:
...
class Model:
    ...
    def __init__(self, device=None):
        ...
        self.cloth_collision_disabled_particles = None
        self.cloth_collision_group_ids = None
        self.disable_inter_garment_collision = 0
...
class ModelBuilder:
    ...
    def add_attachment(
        ...
        """ 
            ...
            Args: 
                ...
                attachment_point: list of point locations, defining the target attachment location
    ...
    def finalize(self, device=None, requires_grad=False) -> Model:
        ...
        with wp.ScopedDevice(device):
            ...
            m.cloth_collision_disabled_particles = wp.zeros(self.particle_count, dtype=wp.int32)
            m.cloth_collision_group_ids = wp.zeros(self.particle_count, dtype=wp.int32)
            m.disable_inter_garment_collision = 0
